...
nix run nixpkgs#openhei           # ou github:heidi-dang/openhei para a branch dev mais recente
```
...
O OpenHei também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/heidi-dang/openhei/releases) ou em [openhei.ai/download](https://openhei.ai/download).
