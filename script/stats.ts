...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/heidi-dang/openhei/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for heidi-dang/openhei...\n")
...
console.log("Fetching npm all-time downloads for openhei-ai...\n")
const npmDownloads = await fetchNpmDownloads("openhei-ai")
