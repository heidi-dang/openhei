...
OpenHei is also available as a desktop application. Download directly from the [releases page](https://github.com/anomalyco/openhei/releases) or [openhei.ai/download](https://openhei.ai/download).
