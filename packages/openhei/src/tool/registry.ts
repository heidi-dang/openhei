...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@openhei-ai/plugin"
import z from "zod"
...
export namespace ToolRegistry {
  ...
  async function all(): Promise<Tool.Info[]> {
    ...
    const question = ["app", "cli", "desktop"].includes(Flag.OPENHEI_CLIENT) || Flag.OPENHEI_ENABLE_QUESTION_TOOL
      ...
      tools
        .filter((t) => {
          ...
          if (t.id === "codesearch" || t.id === "websearch") {
            return model.providerID === "openhei" || Flag.OPENHEI_ENABLE_EXA
          }
