...
import { RunsEventsRoutes } from "./routes/runs-events"
    ...
    () =>
      ...
      app
        ...
        .use(async (c, next) => {
          ...
          const raw = c.req.query("directory") || c.req.header("x-openhei-directory") || process.cwd()
          const directory = (() => {
            try {
        ...
        .post(
          ...
          describeRoute({
            ...
            description: "Clean up and dispose the current OpenHei instance, releasing all resources.",
        ...
        .get(
          ...
          describeRoute({
            summary: "Get paths",
            description:
              "Retrieve the current working directory and related path information for the OpenHei instance.",
        ...
        .get(
          ...
          describeRoute({
            ...
            description: "Get a list of all available commands in the OpenHei system.",
        ...
        .get(
          ...
          describeRoute({
            summary: "List agents",
            description: "Get a list of all available AI agents in the OpenHei system.",
        ...
        .get(
          ...
          describeRoute({
            summary: "List skills",
            description: "Get a list of all available skills in the OpenHei system.",
