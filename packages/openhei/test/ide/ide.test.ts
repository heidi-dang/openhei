...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENHEI_CALLER", () => {
    process.env["OPENHEI_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENHEI_CALLER", () => {
    process.env["OPENHEI_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENHEI_CALLER", () => {
    process.env["OPENHEI_CALLER"] = "unknown"
