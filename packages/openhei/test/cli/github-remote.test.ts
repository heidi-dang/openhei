...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openhei.git")).toEqual({ owner: "sst", repo: "openhei" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openhei")).toEqual({ owner: "sst", repo: "openhei" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openhei.git")).toEqual({ owner: "sst", repo: "openhei" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openhei")).toEqual({ owner: "sst", repo: "openhei" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openhei.git")).toEqual({ owner: "sst", repo: "openhei" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openhei")).toEqual({ owner: "sst", repo: "openhei" })
})
