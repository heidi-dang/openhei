/**
 * OpenAI ChatGPT (Codex) OAuth Authentication Plugin for openhei
 *
 * COMPLIANCE NOTICE:
 ...
 * @author numman-ali
 * @repository https://github.com/numman-ali/openhei-openai-codex-auth
 */
...
/**
 * OpenAI Codex OAuth authentication plugin for openhei
 *
 * This plugin enables openhei to use OpenAI's Codex backend via ChatGPT Plus/Pro
...
export const OpenAIAuthPlugin: Plugin = async ({ client }: PluginInput) => {
	...
	return {
		auth: {
			 ...
			 * 3. Loads user configuration from openhei.json
			 ...
			 * @param provider - Provider configuration from openhei.json
