...
- `minimal-openhei.json`: Simplest setup with defaults
- `openhei-legacy.json`: Legacy complete example with all model variants
- `openhei-modern.json`: Variant-based example for OpenHei v1.0.210+
