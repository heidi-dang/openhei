...
│   ├── openhei-legacy.json       # Legacy full config example (v1.0.209 and below)
│   ├── openhei-modern.json       # Variant config example (v1.0.210+)
│   └── minimal-openhei.json      # Minimal config example
...
- **URL**: `https://your-username.github.io/openhei-codex-plugin/`
