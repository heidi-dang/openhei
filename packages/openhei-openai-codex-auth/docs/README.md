...
Welcome to the OpenHei OpenAI Codex Auth Plugin documentation!
...
**Quick Links**: [GitHub](https://github.com/your-username/openhei-codex-plugin) • [npm](https://www.npmjs.com/package/openhei-openai-codex-auth) • [Issues](https://github.com/your-username/openhei-codex-plugin/issues)
