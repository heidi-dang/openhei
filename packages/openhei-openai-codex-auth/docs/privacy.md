...
This page explains how the OpenHei OpenAI Codex Auth Plugin handles your data and protects your privacy.
...
### Debug Logs
- **Location:** `~/.openhei/logs/codex-plugin/`
...
- **GitHub:** [https://github.com/numman-ali/openhei-openai-codex-auth](https://github.com/numman-ali/openhei-openai-codex-auth)
...
- **Plugin-specific:** [GitHub Issues](https://github.com/numman-ali/openhei-openai-codex-auth/issues)
