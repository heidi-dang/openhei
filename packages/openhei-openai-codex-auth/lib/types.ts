...
/**
 * Plugin configuration from ~/.openhei/openai-codex-auth-config.json
 */
export interface PluginConfig {
	/**
	 * Enable CODEX_MODE (Codex-OpenHei bridge prompt instead of tool remap)
	 * @default true
	 */
	codexMode?: boolean;
}
...
/**
 * User configuration structure from openhei.json
 */
