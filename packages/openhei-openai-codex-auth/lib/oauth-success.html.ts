...
<head>
    ...
    <title>OpenHei - Authentication Successful</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="terminal-window">
            <div class="terminal-header">
                ...
                <div class="terminal-title">openhei-openai-codex-auth@4.4.0 — OAuth Authentication</div>
            </div>
            ...
            <div class="status-box">
                ...
                <div class="terminal-output">
                    ...
                    <div class="terminal-line">
                        <span class="prompt">✓</span>
                        <span class="success">OpenHei ready for deployment</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        // Mix of characters including OpenHei themed ones
        const chars = 'OPENHEI▸✓▹▸◂◃◄►◀▶←→↑↓⟨⟩∧∨∩∪⊂⊃⊆⊇∈∉∀∃∄∅∞≡≠≤≥±∓⊕⊗⊙01';
        const fontSize = 16;
