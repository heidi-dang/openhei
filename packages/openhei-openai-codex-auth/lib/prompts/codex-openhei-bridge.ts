/**
 * Codex-OpenHei Bridge Prompt
 *
 * This prompt bridges Codex CLI instructions to the OpenHei environment.
 ...
 *
 * Token Count: ~450 tokens (~90% reduction vs full OpenHei prompt)
 */

export const CODEX_OPENHEI_BRIDGE = `# Codex Running in OpenHei

You are running Codex through OpenHei, an open-source terminal coding assistant. OpenHei provides different tools but follows Codex operating principles.
...
export interface CodexOpenHeiBridgeMeta {
...
export const CODEX_OPENHEI_BRIDGE_META: CodexOpenHeiBridgeMeta = {
	estimatedTokens: 550,
