    ...
    <main data-page="home">
      ...
      <div data-component="content">
        <section data-component="top">
          <img data-slot="logo light" src={logoLight} alt="openhei logo light" />
          <img data-slot="logo dark" src={logoDark} alt="openhei logo dark" />
        ...
        <section data-component="install">
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                npm install -g <strong>openhei-ai</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                bun install -g <strong>openhei-ai</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                brew install <strong>openhei</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                paru -S <strong>openhei-bin</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
        ...
        <footer data-component="footer">
          <div data-slot="cell">
            <a href="https://x.com/openhei">{i18n.t("footer.x")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://github.com/heidi-dang/openhei">{i18n.t("footer.github")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://openhei.ai/discord">{i18n.t("footer.discord")}</a>
          </div>
        </footer>
      </div>
