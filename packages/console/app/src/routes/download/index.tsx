...
import desktopAppIcon from "../../asset/lander/openhei-desktop-icon.png"
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g openhei-ai")}>
                <code>
                  npm i -g <strong>openhei-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g openhei-ai")}>
                <code>
                  bun add -g <strong>openhei-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/openhei")}>
                <code>
                  brew install <strong>anomalyco/tap/openhei</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S openhei")}>
                <code>
                  paru -S <strong>openhei</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask openhei-desktop")}>
                <code>
                  brew install --cask <strong>openhei-desktop</strong>
                </code>
                <CopyStatus />
              </button>
