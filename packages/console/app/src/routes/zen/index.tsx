...
import compareVideo from "../../asset/lander/openhei-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/openhei-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="openhei:auth" content={loggedin() ? "true" : "false"} />
