...
import { and, Database, eq, isNull, lt, or, sql } from "@openhei-ai/console-core/drizzle/index.js"
import { KeyTable } from "@openhei-ai/console-core/schema/key.sql.js"
import { BillingTable, SubscriptionTable, UsageTable } from "@openhei-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@openhei-ai/console-core/util/price.js"
import { getWeekBounds } from "@openhei-ai/console-core/util/date.js"
import { Identifier } from "@openhei-ai/console-core/identifier.js"
import { Billing } from "@openhei-ai/console-core/billing.js"
import { Actor } from "@openhei-ai/console-core/actor.js"
import { WorkspaceTable } from "@openhei-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@openhei-ai/console-core/model.js"
import { Black, BlackData } from "@openhei-ai/console-core/black.js"
import { UserTable } from "@openhei-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@openhei-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@openhei-ai/console-core/schema/provider.sql.js"
...
export async function handler(
  ...
  const FREE_WORKSPACES = [
    ...
    "wrk_01K6W1A3VE0KMNVSCQT43BG2SX", // openhei bench
  ]
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-openhei-session") ?? ""
    const requestId = input.request.headers.get("x-openhei-request") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-openhei-request")
          headers.delete("x-openhei-session")
          headers.delete("x-openhei-project")
          headers.delete("x-openhei-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (!billing.paymentMethodID)
      throw new CreditsError(
        `No payment method. Add a payment method here: https://openhei.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    if (billing.balance <= 0)
      throw new CreditsError(
        `Insufficient balance. Manage your billing here: https://openhei.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    ...
    if (
      ...
      throw new MonthlyLimitError(
        `Your workspace has reached its monthly spending limit of $${billing.monthlyLimit}. Manage your limits here: https://openhei.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    ...
    if (
      ...
      throw new UserLimitError(
        `You have reached your monthly spending limit of $${authInfo.user.monthlyLimit}. Manage your limits here: https://openhei.ai/workspace/${authInfo.workspaceID}/members`,
      )
