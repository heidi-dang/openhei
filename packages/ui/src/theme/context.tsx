...
const STORAGE_KEYS = {
  THEME_ID: "openhei-theme-id",
  COLOR_SCHEME: "openhei-color-scheme",
  THEME_CSS_LIGHT: "openhei-theme-css-light",
  THEME_CSS_DARK: "openhei-theme-css-dark",
} as const
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { defaultTheme?: string }) => {
    const [store, setStore] = createStore({
      ...
      themeId: props.defaultTheme ?? "hei-1",
