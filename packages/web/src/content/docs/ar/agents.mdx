...
يوجد نوعان من الوكلاء في OpenHei: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي OpenHei مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي OpenHei مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي OpenHei مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `openhei.json`:
...
- عام: `~/.config/openhei/agents/`
- لكل مشروع: `.openhei/agents/`
...
إذا لم يتم تحديد temperature، يستخدم OpenHei القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات OpenHei العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات OpenHei الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [OpenHei Zen](/docs/zen)، فستستخدم `openhei/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `openhei models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/heidi-dang/openhei).
:::
