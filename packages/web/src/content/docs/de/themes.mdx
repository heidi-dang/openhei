...
Mit OpenHei kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet OpenHei das `openhei`-Theme.
...
OpenHei liefert mehrere eingebaute Themes mit.
...
- OpenHei optisch ans Terminal anpassen wollen
...
OpenHei unterstuetzt ein flexibles JSON-basiertes Theme-System.
