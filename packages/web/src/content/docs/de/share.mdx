---
title: Teilen
description: Teile OpenHei-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu OpenHei-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht OpenHei Folgendes:
...
OpenHei hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt OpenHei den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`openhei.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du openhei in deiner Organisation einsetzt.
