---
title: Zen
description: Kuratierte Modellliste direkt von OpenHei.
---
...
OpenHei Zen ist eine vom OpenHei-Team getestete und verifizierte Modellliste.

:::note
OpenHei Zen befindet sich aktuell in der Beta.
:::

Zen funktioniert wie jeder andere Provider in OpenHei.
Du meldest dich bei OpenHei Zen an, holst dir deinen API-Key und nutzt ihn optional.
...
:::tip
Wir haben eine Auswahl aus Modellen und Providern getestet, die gut mit OpenHei funktionieren.
:::
...
OpenHei Zen ist ein AI-Gateway, das dir Zugriff auf genau diese Modelle gibt.

---

## Funktionsweise

OpenHei Zen funktioniert wie jeder andere Provider in OpenHei.

1. Melde dich bei **<a href={console}>OpenHei Zen</a>** an, hinterlege Zahlungsdaten und kopiere deinen API-Key.
2. Fuehre in der TUI `/connect` aus, waehle OpenHei Zen und fuege den API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner OpenHei-Konfiguration hat das Format `openhei/<model-id>`.
Fuer GPT 5.2 Codex verwendest du zum Beispiel `openhei/gpt-5.2-codex`.
...
Wir haben OpenHei Zen entwickelt, um:
...
4. **Kein Lock-in** zu erzwingen, damit du Zen mit anderen Coding-Agents und OpenHei weiter mit anderen Providern nutzen kannst
