---
title: TUI
description: Arbeite mit OpenHei in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenHei bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet OpenHei die TUI im aktuellen Verzeichnis.
...
In der OpenHei-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Add a provider to OpenHei. Allows you to select from available providers and add their API keys.
...
You can customize TUI behavior through your OpenHei config file.
