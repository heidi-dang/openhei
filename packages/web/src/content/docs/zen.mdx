...
| MiniMax M2.5 Free  | minimax-m2.5-free  | `https://opencode.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`        |
| MiniMax M2.1       | minimax-m2.1       | `https://opencode.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`        |
| GLM 5              | glm-5              | `https://opencode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM 5 Free         | glm-5-free         | `https://opencode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM 4.7            | glm-4.7            | `https://opencode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM 4.6            | glm-4.6            | `https://opencode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.5          | kimi-k2.5          | `https://opencode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.5 Free     | kimi-k2.5-free     | `https://opencode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2 Thinking   | kimi-k2-thinking   | `https://opencode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2            | kimi-k2            | `https://opencode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
