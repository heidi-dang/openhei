...
สร้าง `.openhei/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ OpenHei:
...
- ระดับผู้ใช้ (Global): `~/.config/openhei/commands/`
- ระดับโปรเจ็กต์: `.openhei/commands/`
...
OpenHei มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
