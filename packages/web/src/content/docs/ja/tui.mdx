---
title: TUI
description: OpenHei ターミナルユーザーインターフェイスの使用。
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenHei は、LLM を使用してプロジェクトを作業するための対話型ターミナルインターフェイスまたは TUI を提供します。

OpenHei を実行すると、現在のディレクトリの TUI が開始されます。
...
OpenHei TUI を使用する場合、「`/`」に続いてコマンド名を入力すると、アクションをすばやく実行できます。例えば：
...
OpenHei にプロバイダーを追加します。利用可能なプロバイダーから選択し、その API キーを追加できます。
...
OpenHei 設定ファイルを通じて TUI の動作をカスタマイズできます。
