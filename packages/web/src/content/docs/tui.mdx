---
title: TUI
description: Using the OpenHei terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenHei provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running OpenHei starts the TUI for the current directory.
...
When using the OpenHei TUI, you can type `/` followed by a command name to quickly execute actions. For example:
