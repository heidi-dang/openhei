---
title: TUI
description: Bruke openhei-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

openhei gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre openhei starter TUI for gjeldende katalog.
...
Når du bruker openhei TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til openhei. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt openhei. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-oppførselen gjennom openhei-konfigurasjonsfilen.
