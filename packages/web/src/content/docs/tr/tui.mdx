---
title: TUI
description: openhei terminal arayuzunu kullanin.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

openhei, projelerinizde LLM ile calismak icin etkilesimli bir terminal arayuzu (TUI) sunar.

openhei'u calistirdiginizda mevcut dizin icin TUI baslar.
...
openhei TUI kullanirken `/` ve komut adini yazarak hizli eylemler calistirabilirsiniz. Ornek:
...
openhei'a bir provider ekler. Mevcut provider'lari secip API anahtarlari eklemenizi saglar.
...
openhei'dan cikar. _Takma adlar_: `/quit`, `/q`
...
TUI davranisini openhei config dosyanizdan ozellestirebilirsiniz.
