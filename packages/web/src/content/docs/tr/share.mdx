---
title: Paylasim
description: openhei konusmalarini genel baglantilarla paylasin.
---

openhei'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda openhei:
...
openhei, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak openhei manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `openhei.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda openhei kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
