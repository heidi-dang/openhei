---
title: Özel Araçlar
description: LLM'un openhei'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. openhei'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.openhei/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/openhei/tools/` içine yerleştirerek.
