...
description: openhei dile özgü biçimlendiriciler kullanır.
---

openhei, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

openhei, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, openhei bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

openhei bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri openhei yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
