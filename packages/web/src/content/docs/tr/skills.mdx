...
Ajan becerileri, openhei'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
openhei su konumlari tarar:

- Proje konfigurasyonu: `.openhei/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/openhei/skills/<name>/SKILL.md`
...
Proje yerel yollarinda openhei, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.openhei/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/openhei/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.openhei/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
openhei, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`openhei.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`openhei.json` icinde):
