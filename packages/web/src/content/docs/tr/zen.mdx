---
title: Zen
description: openhei ekibinin sundugu secili model listesi.
---
...
OpenHei Zen, openhei ekibi tarafindan test edilip dogrulanmis modellerin listesidir.

:::note
OpenHei Zen su anda beta asamasindadir.
:::

Zen, openhei'daki diger provider'lar gibi calisir. OpenHei Zen'e giris yapar ve API anahtarinizi alirsiniz.
Tamamen istege baglidir; openhei kullanmak icin Zen kullanmak zorunda degilsiniz.
...
:::tip
openhei ile iyi calisan belirli model/provider kombinasyonlarini test ettik.
:::
...
OpenHei Zen, bu modellere erisim saglayan bir AI gateway'dir.

---

## Nasil calisir

OpenHei Zen, openhei'daki diger provider'lar gibi calisir.

1. **<a href={console}>OpenHei Zen</a>** hesabina giris yapin, odeme bilgilerinizi ekleyin ve API anahtarinizi kopyalayin
2. TUI'da `/connect` komutunu calistirin, OpenHei Zen'i secin ve API anahtarinizi yapistirin
...
openhei config'inizdeki [model id](/docs/config/#models), `openhei/<model-id>` formatini kullanir.
Ornegin GPT 5.2 Codex icin config'te `openhei/gpt-5.2-codex` kullanirsiniz.
...
- GLM 4.7 Free, sinirli bir sure icin openhei'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Kimi K2.5 Free, sinirli bir sure icin openhei'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- MiniMax M2.1 Free, sinirli bir sure icin openhei'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Big Pickle, sinirli bir sure icin openhei'da ucretsiz olan gizli bir modeldir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
...
OpenHei Zen'i su amaclarla olusturduk:
...
4. Herhangi bir kodlama ajaniyla kullanima izin vererek **kilitlenmeyi onlemek** ve openhei'da diger provider'lari her zaman acik tutmak
