...
Der er to typer agenter i OpenHei; primære agenter og subagenter.
...
OpenHei leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
OpenHei leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

OpenHei leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `openhei.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger OpenHei modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale OpenHei-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din OpenHei-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [OpenHei Zen](/docs/zen), vil du bruge `openhei/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `openhei models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/heidi-dang/openhei).
:::
