---
title: TUI
description: Brug af OpenHei-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenHei giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre OpenHei starter TUI for den nuværende mappe.
...
Når du bruger OpenHei TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til OpenHei. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut OpenHei. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-adfærden gennem OpenHei-konfigurationsfilen.
