...
Agentferdigheter lar OpenHei oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går OpenHei opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
OpenHei viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `openhei.json`:
