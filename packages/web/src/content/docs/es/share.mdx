---
title: Compartir
description: Comparte tus conversaciones OpenHei.
---

La función para compartir de OpenHei te permite crear enlaces públicos a tus conversaciones de OpenHei, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, OpenHei:
...
OpenHei admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, OpenHei usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `openhei.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de openhei en su organización.
