---
title: TUI
description: Usando la interfaz de usuario del terminal OpenHei.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenHei proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar OpenHei se inicia TUI para el directorio actual.
...
Cuando utilice OpenHei TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a OpenHei. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de OpenHei. _Alias_: `/quit`, `/q`
...
Puede personalizar el comportamiento de TUI a través de su archivo de configuración OpenHei.
