---
title: Zen
description: Liste organisée de modèles fournis par OpenHei.
---
...
OpenHei Zen est une liste de modèles testés et vérifiés fournie par l'équipe OpenHei.

:::note
OpenHei Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans OpenHei. Vous vous connectez à OpenHei Zen et obtenez
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec OpenHei.
:::
...
OpenHei Zen est une passerelle IA qui vous donne accès à ces modèles.

---

## Comment ça marche

OpenHei Zen fonctionne comme n'importe quel autre fournisseur dans OpenHei.

1. Vous vous connectez à **<a href={console}>OpenHei Zen</a>**, ajoutez votre facturation
   détails et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez OpenHei Zen et collez votre clé API.
...
| MiniMax M2.1 Free  | minimax-m2.1-free  | `https://openhei.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| GLM 4.7            | glm-4.7            | `https://openhei.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7 Free       | glm-4.7-free       | `https://openhei.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
Le [id du modèle](/docs/config/#models) dans votre configuration OpenHei
utilise le format `openhei/<model-id>`. Par exemple, pour GPT 5.2 Codex, vous devez
utilisez `openhei/gpt-5.2-codex` dans votre configuration.
...
- GLM 4.7 Free est disponible sur OpenHei pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Kimi K2.5 Free est disponible sur OpenHei pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- MiniMax M2.1 Free est disponible sur OpenHei pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Big Pickle est un modèle furtif gratuit sur OpenHei pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
...
Nous avons créé OpenHei Zen pour :
...
4. N'ayez **aucun verrouillage** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et laissez-vous toujours utiliser n'importe quel autre fournisseur avec OpenHei également.
