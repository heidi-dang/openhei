...
Utwórz `.openhei/commands/test.md`:
...
Możesz zdefiniować polecenia w `openhei.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji openhei:
...
- Globalnie: `~/.config/openhei/commands/`
- Na projekt: `.openhei/commands/`
...
openhei zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
