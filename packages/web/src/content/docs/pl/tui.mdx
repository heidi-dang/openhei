---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala openhei.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

openhei zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie openhei uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI openhei, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do openhei. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij openhei. _Aliasy_: `/quit`, `/q`
...
Możesz dostosować zachowanie TUI za pomocą pliku konfiguracyjnego openhei.
