---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez openhei.
---
...
OpenHei Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół openhei.

:::note
OpenHei Zen is currently in beta.
:::

Zen działa jak każdy inny dostawca openhei. Logujesz się do OpenHei Zen i dostajesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z openhei.
:::
...
OpenHei Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

OpenHei Zen działa jak każdy inny dostawca openhei.

1. Logujesz się do **<a href={console}>OpenHei Zen</a>**, dodajesz swoje rozliczenia
   szczegóły i skopiuj klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz OpenHei Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji openhei
używa formatu `openhei/<model-id>`. Na przykład w przypadku Kodeksu GPT 5.2 zrobiłbyś to
użyj `openhei/gpt-5.2-codex` w swojej konfiguracji.
...
- GLM 4.7 Free jest dostępny na platformie openhei przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Kimi K2.5 Free jest dostępny na openhei przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- MiniMax M2.1 Free jest dostępny na platformie openhei przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w openhei przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
4. Nie **nie blokuj**, umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalaj na korzystanie z openhei dowolnego innego dostawcy.
