...
OpenHei ima listu veza tipki koje možete prilagoditi preko OpenHei konfiguracije.
...
OpenHei koristi `leader` (vodeću) tipku za većinu povezivanja tipki. Ovo izbjegava sukobe u vašem terminalu.
...
Unos prompta aplikacije OpenHei za desktop podržava uobičajene prečice u stilu Readline/Emacs za uređivanje teksta. One su ugrađene i trenutno se ne mogu konfigurirati putem `openhei.json`.
