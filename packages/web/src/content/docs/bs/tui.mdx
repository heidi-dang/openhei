---
title: TUI
description: Korištenje korisničkog interfejsa OpenHei terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenHei pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje OpenHei pokreće TUI za trenutni direktorij.
...
Kada koristite OpenHei TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u OpenHei. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz OpenHei. _Aliases_: `/quit`, `/q`
...
Možete prilagoditi TUI ponašanje putem vašeg OpenHei konfiguracionog fajla.
