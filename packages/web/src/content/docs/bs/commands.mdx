...
Kreiraj `.openhei/commands/test.md`:
...
Možete dodati prilagođene komande kroz OpenHei konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom OpenHei [config](/docs/config):
...
- Globalno: `~/.config/openhei/commands/`
- Po projektu: `.openhei/commands/`
...
OpenHei uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
