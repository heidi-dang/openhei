import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@openhei-ai/sdk/v2"
import { SessionTurn } from "@openhei-ai/ui/session-turn"
import { SessionReview } from "@openhei-ai/ui/session-review"
import { DataProvider } from "@openhei-ai/ui/context"
import { DiffComponentProvider } from "@openhei-ai/ui/context/diff"
import { CodeComponentProvider } from "@openhei-ai/ui/context/code"
import { WorkerPoolProvider } from "@openhei-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@openhei-ai/ui/logo"
import { IconButton } from "@openhei-ai/ui/icon-button"
import { ProviderIcon } from "@openhei-ai/ui/provider-icon"
import { createDefaultOptions } from "@openhei-ai/ui/pierre"
...
import { Tabs } from "@openhei-ai/ui/tabs"
import { MessageNav } from "@openhei-ai/ui/message-nav"
import { preloadMultiFileDiff, PreloadMultiFileDiffResult } from "@pierre/diffs/ssr"
import { Diff as SSRDiff } from "@openhei-ai/ui/diff-ssr"
import { clientOnly } from "@solidjs/start"
import { type IconName } from "@openhei-ai/ui/icons/provider"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyDiff = clientOnly(() => import("@openhei-ai/ui/diff").then((m) => ({ default: m.Diff })))
const ClientOnlyCode = clientOnly(() => import("@openhei-ai/ui/code").then((m) => ({ default: m.Code })))
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@openhei-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/openhei-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | OpenHei</Title>
              </Show>
              <Meta name="description" content="openhei - The AI coding agent built for the terminal." />
                          ...
                          <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                            <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                              ...
                              <div class="flex gap-3 items-center">
                                <IconButton
                                  as={"a"}
                                  href="https://github.com/heidi-dang/openhei"
                                  target="_blank"
                                  icon="github"
                                  variant="ghost"
                                />
