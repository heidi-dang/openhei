...
/**
 * Server configuration for openhei serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: openhei.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://openhei.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
