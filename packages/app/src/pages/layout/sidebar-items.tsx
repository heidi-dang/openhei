...
import { Avatar } from "@openhei-ai/ui/avatar"
import { DiffChanges } from "@openhei-ai/ui/diff-changes"
import { HoverCard } from "@openhei-ai/ui/hover-card"
...
import { type Message, type Session, type TextPart, type UserMessage } from "@openhei-ai/sdk/v2/client"
import { For, Match, Show, Switch, createMemo, onCleanup, type Accessor, type JSX } from "solid-js"
import { agentColor } from "@/utils/agent"

const OPENHEI_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === OPENHEI_PROJECT_ID ? "https://openhei.ai/favicon.svg" : props.project.icon?.override
          }
