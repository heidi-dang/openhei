export const dict = {
  ...
  "dialog.provider.openhei.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OpenHei",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OpenHei.",
  ...
  "provider.connect.openheiZen.line1":
    "OpenHei Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.openheiZen.visit.prefix": "Odwiedź ",
  "provider.connect.openheiZen.visit.link": "openhei.ai/zen",
  "provider.connect.openheiZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OpenHei.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OpenHei.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w openhei.json",
  ...
  "dialog.server.description": "Przełącz serwer OpenHei, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja OpenHei ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OpenHei",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (openhei.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "OpenHei zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OpenHei",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd OpenHei na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OpenHei.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OpenHei",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OpenHei.",
