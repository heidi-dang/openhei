export const dict = {
  ...
  "dialog.provider.openhei.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من OpenHei",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في OpenHei.",
  ...
  "provider.connect.openheiZen.line1":
    "يمنحك OpenHei Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.openheiZen.visit.prefix": "قم بزيارة ",
  "provider.connect.openheiZen.visit.link": "openhei.ai/zen",
  "provider.connect.openheiZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في OpenHei.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في OpenHei.",
  ...
  "prompt.toast.sessionRecovered.title": "تعذر العثور على الجلسة",
  "prompt.toast.sessionRecovered.description": "تعذر العثور على الجلسة السابقة، وبدأنا جلسة جديدة.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في openhei.json",
  ...
  "dialog.server.description": "تبديل خادم OpenHei الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من OpenHei ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق OpenHei",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (openhei.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن OpenHei لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن OpenHei نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم OpenHei داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ OpenHei",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور OpenHei على جهازك",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة OpenHei.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل OpenHei",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من OpenHei.",
