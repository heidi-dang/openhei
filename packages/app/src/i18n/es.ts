export const dict = {
  ...
  "dialog.provider.openhei.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por OpenHei",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en OpenHei.",
  ...
  "provider.connect.openheiZen.line1":
    "OpenHei Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.openheiZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.openheiZen.visit.prefix": "Visita ",
  "provider.connect.openheiZen.visit.link": "openhei.ai/zen",
  "provider.connect.openheiZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en OpenHei.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en OpenHei.",
  ...
  "prompt.toast.sessionRecovered.title": "Sesión no encontrada",
  "prompt.toast.sessionRecovered.description": "No se encontró la sesión anterior, se inició una nueva sesión.",
  ...
  "dialog.plugins.empty": "Plugins configurados en openhei.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de OpenHei se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de OpenHei ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de OpenHei",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (openhei.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, OpenHei no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "OpenHei incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor OpenHei dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para OpenHei",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve OpenHei en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de OpenHei.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia OpenHei",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de OpenHei.",
