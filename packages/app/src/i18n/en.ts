export const dict = {
  ...
  "error.contextOverflow": "Context Overflow",
  ...
  "provider.status.retrying": "Retrying",
  "provider.status.busy": "Busy",
  "provider.status.code": "Status code: {{code}}",
  "provider.status.retryingIn": "Retrying in {{seconds}}s",
  "provider.retry.title": "Retry",
  "provider.retry.description": "Retry the request",
  ...
  "settings.swarm.title": "Swarm Mode",
  "settings.swarm.description": "Configure Swarm Mode for concurrent sub-agent execution.",
  "settings.swarm.enabled": "Enable Swarm Mode",
  "settings.swarm.enabled.description": "Allow the main agent to spawn up to 2 sub-agents for parallel task execution.",
  "settings.swarm.subagent1": "Sub-agent #1 Model",
  ...
  "settings.swarm.toast.saved": "Swarm settings saved",
  "settings.swarm.toast.error": "Failed to save swarm settings",

  "swarm.title": "Swarm",
  "swarm.main": "Main",
  "swarm.subagent": "Sub-agent",
  "swarm.status.working": "Working",
  "swarm.status.idle": "Idle",
  "swarm.status.done": "Done",
  "swarm.status.error": "Error",
  "swarm.consent.title": "Sub-agent Request",
  "swarm.consent.subtitle": "The main agent wants to spawn sub-agents",
  "swarm.consent.planned": "Planned tasks",
  "swarm.consent.models": "Models",
  "swarm.consent.accept": "Accept",
  "swarm.consent.deny": "Deny",
