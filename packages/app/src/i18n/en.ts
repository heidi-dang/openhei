export const dict = {
  ...
  "dialog.provider.group.subscription": "Subscription Login",
  ...
  "dialog.provider.mcopilot.note": "GPT-4 models via Microsoft Copilot session",
  "dialog.provider.alternative.note": "Connect via subscription session bridge",
  ...
  "settings.providers.section.subscription": "Subscription login",
