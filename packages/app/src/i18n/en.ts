export const dict = {
  ...
  "dialog.provider.openhei.note": "Curated models including Claude, GPT, Gemini and more",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OpenHei",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenHei.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.openheiZen.line1":
    "OpenHei Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.openheiZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.openheiZen.visit.prefix": "Visit ",
  "provider.connect.openheiZen.visit.link": "openhei.ai/zen",
  "provider.connect.openheiZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenHei.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenHei.",
  ...
  "dialog.plugins.empty": "Plugins configured in openhei.json",
  ...
  "dialog.server.description": "Switch which OpenHei server this app connects to.",
  ...
  "toast.update.description": "A new version of OpenHei ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenHei team",
  ...
  "error.chain.checkConfig": "Check your config (openhei.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OpenHei does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OpenHei includes free models so you can start immediately.",
  "sidebar.gettingStarted.line2": "Connect any provider to use models, inc. Claude, GPT, Gemini etc.",
  "sidebar.project.recentSessions": "Recent sessions",
  "sidebar.project.viewAllSessions": "View all sessions",
  "sidebar.project.clearNotifications": "Clear notifications",

  "app.name.desktop": "OpenHei Desktop",
  ...
  "settings.desktop.wsl.description": "Run the OpenHei server inside WSL on Windows.",
  ...
  "settings.general.row.appearance.description": "Customise how OpenHei looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenHei is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenHei launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenHei.",
  ...
  "settings.agents.description": "Create and manage custom agents with specialized prompts, tools, and handoffs.",
  "settings.agents.empty": "No agents configured",
  "settings.agents.empty.description": "Create your first agent to get started with multi-agent collaboration.",
  "settings.agents.add": "Add Agent",
  "settings.agents.delete.title": "Delete agent",
  "settings.agents.delete.confirm": "Delete agent \"{{name}}\"?",
  "settings.agents.delete.button": "Delete",
  "settings.agents.field.name": "Name",
  "settings.agents.field.name.placeholder": "e.g. plan, reviewer, bugfix",
  "settings.agents.field.description": "Description",
  "settings.agents.field.description.placeholder": "When to use this agent...",
  "settings.agents.field.prompt": "System Prompt",
  "settings.agents.field.prompt.placeholder": "Instructions for this agent...",
  "settings.agents.field.mode": "Mode",
  "settings.agents.field.mode.primary": "Primary",
  "settings.agents.field.mode.subagent": "Sub-agent",
  "settings.agents.field.mode.all": "All",
  "settings.agents.field.model": "Model",
  "settings.agents.field.model.default": "Default model",
  "settings.agents.field.steps": "Max Steps",
  "settings.agents.field.steps.placeholder": "Max agentic iterations",
  "settings.agents.field.temperature": "Temperature",
  "settings.agents.field.color": "Color",
  "settings.agents.field.hidden": "Hidden",
  "settings.agents.field.hidden.description": "Hide from @ autocomplete menu",
  "settings.agents.field.disable": "Disabled",
  "settings.agents.field.disable.description": "Disable this agent",
  "settings.agents.section.capabilities": "Capabilities",
  "settings.agents.tool.read": "Read files",
  "settings.agents.tool.edit": "Edit files",
  "settings.agents.tool.glob": "Find files",
  "settings.agents.tool.grep": "Search code",
  "settings.agents.tool.list": "List directory",
  "settings.agents.tool.bash": "Run commands",
  "settings.agents.tool.task": "Call sub-agents",
