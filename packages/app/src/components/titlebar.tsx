...
import { useTheme } from "@openhei-ai/ui/theme"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div id="openhei-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
      </div>

      <div class="min-w-0 flex items-center justify-center pointer-events-none">
        <div id="openhei-titlebar-center" class="pointer-events-auto w-full min-w-0 flex justify-center lg:w-fit" />
      </div>
      ...
      <div
        ...
        onMouseDown={drag}
      >
        <div id="openhei-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
        <Show when={windows()}>
