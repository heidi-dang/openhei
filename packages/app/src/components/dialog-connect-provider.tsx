import type { ProviderAuthAuthorization } from "@openhei-ai/sdk/v2/client"
...
import { List, type ListRef } from "@openhei-ai/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "openhei"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.openheiZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.openheiZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.openheiZen.visit.prefix")}
                <Link href="https://openhei.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.openheiZen.visit.link")}
                </Link>
                {language.t("provider.connect.openheiZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
