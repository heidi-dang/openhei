...
export const SettingsGeneral: Component = () => {
  ...
  const soundSelectProps = (
    ...
    itemValue: (o: Exclude<(typeof soundOptions)[number], undefined>) => o.id,
    itemLabel: (o: Exclude<(typeof soundOptions)[number], undefined>) => language.t((o as any).label),
      ...
      <div class="bg-surface-raised-base px-4 rounded-lg">
        ...
        <SettingsRow
          ...
          description={
            <>
              ...
              <Link href="https://openhei.ai/docs/themes/">{language.t("common.learnMore")}</Link>
            </>
          }
        >
          <Select
        ...
        >
          <Select
            ...
            itemValue={(o) => o?.value}
            itemLabel={(o) => language.t(o?.label as any)}
