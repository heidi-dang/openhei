...
beforeAll(async () => {
  ...
  mock.module("@openhei-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openhei-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openhei-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openhei-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
