import { useFilteredList } from "@openhei-ai/ui/hooks"
...
import { DockShellForm, DockTray } from "@openhei-ai/ui/dock-surface"
...
import { RadioGroup } from "@openhei-ai/ui/radio-group"
...
import { ImagePreview } from "@openhei-ai/ui/image-preview"
              ...
              <Show when={store.mode === "normal"}>
                ...
                >
                  <Select
                    ...
                    onSelect={(x: string | undefined) => local.model.variant.set(x === "default" ? undefined : x)}
                    class="capitalize max-w-[160px]"
                    valueClass="truncate text-13-regular"
                    triggerStyle={{ height: "28px" }}
                    variant="ghost"
