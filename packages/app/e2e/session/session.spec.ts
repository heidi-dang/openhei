...
const shareDisabled = process.env.OPENHEI_DISABLE_SHARE === "true" || process.env.OPENHEI_DISABLE_SHARE === "1"
...
test("session can be shared and unshared via header button", async ({ page, sdk, gotoSession }) => {
  test.skip(shareDisabled, "Share is disabled in this environment (OPENHEI_DISABLE_SHARE).")
